jQuery(document).ready(function($) {
    ...
    $('input.form_non_branded_mailer').change(function() {
        if($(this).is(":checked")) {
            var form_non_branded_mailer = alldetailobj.totalprice + parseFloat($(this).val());
            $("#showzonevariation").html("$"+form_non_branded_mailer);   
